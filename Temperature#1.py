...
f = open('/Users/calistaadler/Downloads/DFR/tempout.csv', 'w')
writer = csv.writer(f)
...
for index, row in data.iterrows():
    ...
    if temp1_id in data['id'][i:n].tolist():
        ...
        writer.writerow([new_row, modA/10, modB/10, modC/10, gate_driver/10])
     
    i = i + 1
    n = n + 1
    
output = pd.read_csv(r'/Users/calistaadler/Downloads/DFR/tempout.csv')
